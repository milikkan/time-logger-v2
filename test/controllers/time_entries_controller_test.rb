...
class TimeEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create time_entry" do
    assert_difference('TimeEntry.count') do
      post time_entries_url, params: { time_entry: { comment: @time_entry.comment, start: @time_entry.start, stop: @time_entry.stop } }
    end
  ...
  test "should update time_entry" do
    patch time_entry_url(@time_entry), params: { time_entry: { comment: @time_entry.comment, start: @time_entry.start, stop: @time_entry.stop } }
